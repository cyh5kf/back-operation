...
export default class JoinApplication extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    onClickRecordOperation(operationType, record) {
        ...
        var request = (isReject) ? AjaxUtil.rejectJoinApplication : AjaxUtil.approveJoinApplication;
    ...
    queryTableContent() {
        ...
        queryCondition.gender = parseInt(queryCondition.gender,10);

        AjaxUtil.queryJoinApplicationList(queryCondition, function (d) {
                    ...
                    <div>
                        <Row type="flex" justify="start">
                            <Col span="24" className="titleHead">
                                Broadcaster Recruit Application from SOMA
                            </Col>
                        </Row>
